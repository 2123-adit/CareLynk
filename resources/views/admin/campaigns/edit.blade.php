...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    <h1 class="h2"><i class="bi bi-pencil"></i> Edit Kampanye</h1>
        ...
        <form action="{{ route('admin.campaigns.update', $campaign) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('kategori') is-invalid @enderror" 
                                    ...
                                    <option value="Bencana" {{ old('kategori', $campaign->kategori) == 'Bencana' ? 'selected' : '' }}>Bencana</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="target_donasi" 
                                       name="target_donasi" 
                                       value="{{ old('target_donasi', $campaign->target_donasi) }}" 
                                       min="1"
                                       required>
                                @error('target_donasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" 
                                       ...
                                       value="{{ old('tanggal_berakhir', $campaign->tanggal_berakhir->format('Y-m-d\TH:i')) }}" 
                                       required>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle"></i> Update Kampanye
                </button>
            </div>
        </form>
    </div>
